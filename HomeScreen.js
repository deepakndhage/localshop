...
import { Container, Content, Header, Left, Body, Title, Icon, Right,  Item, Input, Card, CardItem} from 'native-base';
...
class HomeScreen extends Component{
    render() {
        return (
          <Container>
              <Header style={{backgroundColor:'#3a455c', height:60, borderBottomColor: '#757575'}}>
                <Left style = {{flexDirection:'row'}}>
                    <Icon onPress={() => this.props.navigation.openDrawer()} name = "md-menu" style = {{color:'white', marginRight:15}}/>
                    <FAIcon name = "linux" style = {{fontSize :32, color:'white'}}/>
                </Left>
                <Right>
